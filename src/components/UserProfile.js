  ...
  return (
    <div className="UserProfile">
      ...
      <p className="UserProfile__Desciption">
        ...
        at the dull weather. DropsOne morning, when Gregor Samsa woke from
        ...
        arches into stiff sections. The bedding was hardly able to cover it and
        ...
        magazine and housed in a nice, gilded frame. It showed a lady fitted out
        with a fur hat and fur boa who sat upright, raising a heavy fur muff
        that covered the whole of her lower arm towards the viewer. Gregor then
        turned to look out the window at the DropsOne morning, when Gregor Samsa
        ...
        by arches into stiff sections. The bedding was hardly able to cover it
        ...
        with a fur hat and fur boa who sat upright, raising a heavy fur muff
        that covered the whole of her lower arm towards the viewer. Gregor then
        turned to look out the window at the dull weather. DropsOne morning,
